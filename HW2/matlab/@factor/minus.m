...
% minus: compute factor which is the arithmetic difference of two factors
% FIX : fnew = minus(f,g) : return a factor which is the difference of two factors f,g
% TODO: !!! (-inf)-(-inf) = -inf (via nan hack)
% See also: times, plus, rdivide
...
% (c) Alexander Ihler 2010
  ...
  t=bsxfun(@minus,reshape(t1,s11),reshape(t2,s21));
  t(isnan(t)) = -inf;
  f.t=t; f.v=v;
