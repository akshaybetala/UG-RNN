...
% compute a new factor which is the arithmetic sum of two factors
% FIX : fnew = plus(f,g) : return a factor which is the sum of two factors f,g
% See also: times, minus, rdivide
...
% (c) Alexander Ihler 2010
  ...
  t=bsxfun(@plus,reshape(t1,s11),reshape(t2,s21));
  f.t=t; f.v=v;
