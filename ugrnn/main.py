...
class UGRNN(object):
    ...
    def __init__(self, sess):
        ...
        self.feature_pls = [tf.placeholder(tf.float32, shape=[None, None, Molecule.num_of_features()]) for i in
                            xrange(batch_size)]
    ...
    def fill_feed_dict(self, dataset, batch_size):
        ...
        for i in xrange(batch_size):
            ...
            feed_dict[self.sequence_len_pls[i]] = molecules_feeds[i].feature_vector.shape[1]
